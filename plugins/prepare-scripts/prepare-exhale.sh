...
# Installs docs autogeneration tool [exhale](https://exhale.readthedocs.io/en/latest/).
#
# Example:
#   ./prepare-exhale.sh
...
mk::help() {
  echo "Installs docs autogeneration tool [exhale](https://exhale.readthedocs.io/en/latest/)."
  echo ""
  echo "Usage:"
  echo ""
  echo "  ./prepare-exhale.sh [options]"
  echo ""
  echo "Options:"
...
mk::main() {
  ...
  mk::info "Installing $(mk::title Exhale):\n"

  pip install exhale
  mk::check_stage "install"

  pip install sphinx_rtd_theme
  mk::check_stage "theme"
